...
SECRET_KEY = 'xeb9(=$1vqqnp8!n_(hf!^s7o*w+wbd%a^frx*af2t&@)(m4!3'
...
FTP_OTHER = os.path.join(BASE_DIR, 'other') 

# FTP config
# ftp 本地用户(应用于虚拟用户映射)与/etc/vsftpd/vsftpd.conf 中guest_username保持一致
FTP_USER = 'vftpuser'
